...
// Begin Class UMyTestCPPLib Function GetMyFirstCPP
struct Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics
{
	struct MyTestCPPLib_eventGetMyFirstCPP_Parms
	{
		FString ReturnValue;
	};
#if WITH_METADATA
...
const UECodeGen_Private::FStrPropertyParams Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MyTestCPPLib_eventGetMyFirstCPP_Parms, ReturnValue), METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::NewProp_ReturnValue,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::PropPointers) < 2048);
const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMyTestCPPLib, nullptr, "GetMyFirstCPP", nullptr, nullptr, Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::PropPointers), sizeof(Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::MyTestCPPLib_eventGetMyFirstCPP_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04022401, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::Function_MetaDataParams) };
static_assert(sizeof(Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::MyTestCPPLib_eventGetMyFirstCPP_Parms) < MAX_uint16);
UFunction* Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP()
{
	static UFunction* ReturnFunction = nullptr;
	if (!ReturnFunction)
	{
		UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP_Statics::FuncParams);
	}
	return ReturnFunction;
}
DEFINE_FUNCTION(UMyTestCPPLib::execGetMyFirstCPP)
{
	P_FINISH;
	P_NATIVE_BEGIN;
	*(FString*)Z_Param__Result=UMyTestCPPLib::GetMyFirstCPP();
	P_NATIVE_END;
}
// End Class UMyTestCPPLib Function GetMyFirstCPP
...
void UMyTestCPPLib::StaticRegisterNativesUMyTestCPPLib()
{
	...
	static const FNameNativePtrPair Funcs[] = {
		...
		{ "GetMyFirstCPP", &UMyTestCPPLib::execGetMyFirstCPP },
	};
...
struct Z_Construct_UClass_UMyTestCPPLib_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMyTestCPPLib_GetMyFirstCPP, "GetMyFirstCPP" }, // 3638056069
	};
...
struct Z_CompiledInDeferFile_FID_Users_gangh_Downloads_SampleChat_SampleChat_Source_SampleChat_Public_MyTestCPPLib_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UMyTestCPPLib, UMyTestCPPLib::StaticClass, TEXT("UMyTestCPPLib"), &Z_Registration_Info_UClass_UMyTestCPPLib, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMyTestCPPLib), 2735147225U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_gangh_Downloads_SampleChat_SampleChat_Source_SampleChat_Public_MyTestCPPLib_h_24453632(TEXT("/Script/SampleChat"),
